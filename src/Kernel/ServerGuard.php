...
use Zhifu99\Kernel\Contracts\MessageInterface;
use Zhifu99\Kernel\Exceptions\BadRequestException;
use Zhifu99\Kernel\Exceptions\InvalidArgumentException;
use Zhifu99\Kernel\Messages\Message;
use Zhifu99\Kernel\Messages\News;
use Zhifu99\Kernel\Messages\NewsItem;
use Zhifu99\Kernel\Messages\Raw as RawMessage;
use Zhifu99\Kernel\Messages\Text;
use Zhifu99\Kernel\Support\XML;
use Zhifu99\Kernel\Traits\Observable;
use Zhifu99\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
    ...
    /**
     * @var \Zhifu99\Kernel\ServiceContainer
     */
    protected $app;
     ...
     * @return $this
     *
     * @throws \Zhifu99\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\Zhifu99\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \Zhifu99\Kernel\Exceptions\InvalidArgumentException
     * @throws \Zhifu99\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \Zhifu99\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \Zhifu99\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \Zhifu99\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */
